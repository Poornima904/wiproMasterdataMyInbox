		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#masterdatanamespaceworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"masterdatanamespaceworkflowuimodule-display": {
								"semanticObject": "masterdatanamespaceworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=masterdatanamespace.workflowuimodule",
									"url": sap.ui.require.toUrl("masterdatanamespace/workflowuimodule")
								}
							}
						}
					}
