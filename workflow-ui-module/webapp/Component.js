sap.ui.define(
  [
    ...
    "sap/ui/Device",
    "masterdatanamespace/workflowuimodule/model/models",
  ],
  function (UIComponent, Device, models) {
    "use strict";

    return UIComponent.extend(
      "masterdatanamespace.workflowuimodule.Component",
      {
        metadata: {
          manifest: "json",
        },
        ...
        */
        init: function () {
          ...
          this.getInboxAPI().addAction(
            ...
            async function () {
              debugger
              var data = this.getModel("device").getData().data;
              data = JSON.parse(data);
              var masterdataid = data.masterdataid;
              let testdata = JSON.stringify({
                Statusnew: 'Rejected'
              });
             
              await $.ajax({
                // url: url + masterdataid,
                url: `https://7d2927dbtrial-dev-wiprocompilance-srv.cfapps.us10-001.hana.ondemand.com/odata/v4/my/MasterData(Masterdataid='${masterdataid}',IsActiveEntity=true)`,
                method: 'PATCH',
